  ...
  return (
    <div style={{ 
      ...
      <ol>
        ...
        <li>Use <code>https://yourdomain.com/oauth2/&#123;provider&#125;/callback</code> as your OAuth redirect URI</li>
        <li>This proxy will automatically forward all OAuth callbacks to StackOne</li>
      </ol>
      
      <h2>OAuth Redirect Endpoint:</h2>
      <p>
        <strong>GET/POST</strong> <code>/oauth2/&#123;provider&#125;/callback</code>
      </p>
      <p>
      ...
      <p>
        ...
        <br />
        <code>https://myapp.com/oauth2/google/callback</code>
        <br />
        <code>https://myapp.com/oauth2/microsoft/callback</code>
        <br />
        <code>https://myapp.com/oauth2/slack/callback</code>
      </p>
